...
if (toolEquipped == 1 && forwardTileX != undefined && forwardTileY != undefined) {
	    draw_set_color(c_yellow);
    if (facing == 270) {
        draw_rectangle(forwardTileX, forwardTileY, forwardTileX, forwardTileY, true);
    }
    else if (facing == 90) {
        draw_rectangle(forwardTileX, forwardTileY,forwardTileX, forwardTileY, true);
    }
        ...
        draw_rectangle(forwardTileX+16, forwardTileY+16,forwardTileX-16, forwardTileY-16, true);
    }
}
...
#region -------------------------------------show collisions-----------------------------------------------

if (debug != undefined) {
	if (debug = 1) {
	    with (obj_parCollision) {
