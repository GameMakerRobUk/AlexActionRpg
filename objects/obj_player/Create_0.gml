...
debug = false;
    ...
    #region -------------set player sprites to be used based on action being done------------------------
    ...
    #endregion set player sprites to be used based on action being done

    #region ---------------------------------character parts--------------------------------------------
    ...
    #region -------------------------farming, crafting, etc mechanics-----------------------------------

        tilledEarthDetected = false;
        objectToPickUp  = undefined;
        objectType = undefined;

    #endregion farming, crafting, etc mechanics
    ...
    #endregion stamina use

    #region --------------------------------set facing coords-------------------------------------------
    ...
    #endregion set facing coords

    #region ---------------what is currently being used and what is equipped--------------------
    ...
    #endregion what is currently being used and what is equipped    
