...
a_displayFunction[e_display.fullScreen][0] = scr_displaySetFullscreen;
//a_displayFunction[e_display.windowedFullScreen][0] = scr_displaySetWindowedFullscreen;
a_displayFunction[e_display.windowed][0] = scr_displaySetWindowed;
a_displayFunction[e_display.fullScreen][1] = "Fullscreen";
//a_displayFunction[e_display.windowedFullScreen][1] = "Windowed-Fullscreen";
...
snd[room_titleScreen] = snd_titleScreen; 
...
//for(var i = 0; i< e_actors.last; i++){
//	show_debug_message(string(global.stats[# e_stats.blockChance, i]));
//}
...
global.ordString[vk_left] = "Lesft Arrow";
