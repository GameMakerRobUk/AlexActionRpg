function Script11(){
    ...
    #region ----------------------------------facing right----------------------------------------------
        case 0  :
            ...
            if (idle = false) {
            	draw_sprite_part(playerBaseRight, image_index, 0, 0, 64, 64, x-32, y-64);
            	...
            	draw_sprite_part(playerBaseRightIdle, image_index, 0, 0, 64, 64, x-32, y-64);
    ...
    #region -----------------------------------facing up-------------------------------------------------
        case 90  :
            ...
            if (idle = false) {
            	draw_sprite_part(playerBaseUp, image_index, 0, 0, 64, 64, x-32, y-64);
            	...
            	draw_sprite_part(playerBaseUpIdle, image_index, 0, 0, 64, 64, x-32, y-64);
    ...
    #region ----------------------------------facing left------------------------------------------------
        case 180  :
            if (playerShadowSide != -1) draw_sprite_part(playerShadowSide, 0, 0, 0, 32, 32, x-16, y-16);
            if (idle = false) {
            	draw_sprite_part(playerBaseLeft, image_index, 0, 0, 64, 64, x-32, y-64);
            	...
            	draw_sprite_part(playerBaseLeftIdle, image_index, 0, 0, 64, 64, x-32, y-64);
    ...
    #region ----------------------------------facing down----------------------------------------------
        case 270  :
            if (playerShadowFront != -1) draw_sprite_part(playerShadowFront, 0, 0, 0, 32, 32, x-16, y-16);
            if (idle = false) {
            	draw_sprite_part(playerBaseDown, image_index, 0, 0, 64, 64, x-32, y-64);
            	...
            	draw_sprite_part(playerBaseLeftDown, image_index, 0, 0, 64, 64, x-32, y-64);
